...
(function (factory) {
  ...
  Timer.prototype.setFinalValue = function(finalValues, element) {
    ...
    element.find('.' + this._options.classNameSeconds).html(finalValues.pop() + '<span>ثانیه</span>');
    element.find('.' + this._options.classNameMinutes).html(finalValues.pop() + '<span>دقیقه</span>');
    element.find('.' + this._options.classNameHours).html(finalValues.pop() + '<span>ساعت</span>');
  };
